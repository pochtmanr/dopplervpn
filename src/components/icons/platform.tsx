/**
 * Outline icons shared by the platform landing pages.
 *
 * Extracted verbatim from `vpn-for-{ios,android,macos,windows}/page.tsx`, where
 * the same paths were re-declared once per page — ShieldIcon appeared four
 * times, CheckIcon four, ArrowIcon four. The SVG bodies are unchanged, so the
 * rendered output is identical to what each page drew before.
 *
 * All render at `w-5 h-5` unless a `className` is passed.
 */
