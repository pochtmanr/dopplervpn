...
export async function Footer() {
  ...
  const productLinks: LinkItem[] = [
    ...
    { href: "/downloads", label: t("download") },
    ...(showBlogLink ? [{ href: "/blog", label: t("blog") }] : []),
  ...
  const legalLinks: LinkItem[] = [
    ...
    { href: "/dpa", label: t("dataProcessing") },
    { href: "/subprocessors", label: t("subprocessors") },
    { href: "/delete-account", label: t("deleteAccount") },
  ];

  return (
    <footer className="relative overflow-hidden bg-bg-secondary/50 border-t border-overlay/5">
      <div
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="text-text-muted hover:text-text-primary transition-colors"
                aria-label="Simnetiq on Instagram"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
