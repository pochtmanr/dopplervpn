...
const SLUG = "vpn-for-travelers-china";
const NAMESPACE = "vpnForTravelersChina";
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <SeoLandingPage
      ...
      related={[
        { href: "/vpn-for-china", titleKey: "chinaHubTitle", descKey: "chinaHubDesc" },
        { href: "/vless-vpn", titleKey: "vlessTitle", descKey: "vlessDesc" },
        { href: "/vpn-for-public-wifi-iphone", titleKey: "wifiTitle", descKey: "wifiDesc" },
      ]}
    />
  );
}
